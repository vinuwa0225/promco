...
function Medical() {
  ...
  useEffect(() => {
    const getddtdata = axios({
      ...axioDefaultConfig,
      method: 'get',
      url: process.env.REACT_APP_INSEE_KIOSK_BACKEND_API + '/api/report/allworkerhealthrecord',
    ...
    <div className='card card-xl-stretch mb-xl-8'>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder text-dark'>All Fleet Driver & Helper</span>
          <span className='text-muted mt-1 fw-bold fs-7'>Health Records</span>
        </h3>
