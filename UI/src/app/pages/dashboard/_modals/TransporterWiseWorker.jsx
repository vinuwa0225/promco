...
function TransporterWiseWorker() {
  ...
  useEffect(() => {
    const getddtdata = axios({
      ...axioDefaultConfig,
      method: 'get',
      url: process.env.REACT_APP_INSEE_KIOSK_BACKEND_API + '/api/report/transportersworker',
    ...
    <div className='card card-xl-stretch mb-xl-8'>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder text-dark'>Transporter Wise</span>
          <span className='text-muted mt-1 fw-bold fs-7'>Driver & Helpers Distribution</span>
        </h3>
      ...
      <div className='card-body pt-2'>
        ...
        {!InitialLoading && (
          <ResponsiveContainer width='100%' height={300}>
            <BarChart width={500} height={300} data={state}>
              <defs>
              ...
              <XAxis dataKey='name' angle={-75} dy={-60} />
              <YAxis />
              <Tooltip />
              <Legend />
              <Bar dataKey='Driver' stroke='#8884d8' fillOpacity={1} fill='url(#colorUv)' />
              <Bar dataKey='Helper' stroke='#82ca9d' fillOpacity={1} fill='url(#colorPv)' />
            </BarChart>
          </ResponsiveContainer>
        )}
      </div>
...
export default TransporterWiseWorker
