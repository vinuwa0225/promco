    ...
    return (react_1.default.createElement("div", { className: "card ".concat(className) },
        react_1.default.createElement("div", { className: 'card-body pb-0' },
            react_1.default.createElement("div", { className: 'd-flex align-items-center mb-5' },
                react_1.default.createElement("div", { className: 'd-flex align-items-center flex-grow-1' },
                    ...
                    react_1.default.createElement("div", { className: 'd-flex flex-column' },
                        react_1.default.createElement("a", { href: '#', className: 'text-gray-800 text-hover-primary fs-6 fw-bolder' }, "Nick Logan"),
                        react_1.default.createElement("span", { className: 'text-gray-400 fw-bold' }, "PHP, SQLite, Artisan CLI"))),
            ...
            react_1.default.createElement("div", { className: 'mb-5' },
                react_1.default.createElement("p", { className: 'text-gray-800 fw-normal mb-5' }, "Outlines keep you honest. They stop you from indulging in poorly thought-out metaphors about driving and keep you focused on the overall structure of your post"),
                react_1.default.createElement("div", { className: 'd-flex align-items-center mb-5' },
...
exports.FeedsWidget2 = FeedsWidget2;
