...
exports.Card3 = void 0;
var helpers_1 = require("../../../helpers");
var Card3 = function (_a) {
    ...
    return (React.createElement("div", { className: 'card' },
        React.createElement("div", { className: 'card-body d-flex flex-center flex-column p-9' },
            ...
            React.createElement("a", { href: '#', className: 'btn btn-sm btn-light' },
                React.createElement(helpers_1.KTSVG, { path: '/media/icons/duotune/arrows/arr075.svg', className: 'svg-icon-3' }),
                "Connect"))));
};
exports.Card3 = Card3;
